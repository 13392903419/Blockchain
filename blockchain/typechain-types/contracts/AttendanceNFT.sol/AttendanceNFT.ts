...
export namespace RoleManagerUpdatedEvent {
  export type InputTuple = [
    oldRoleManager: AddressLike,
    newRoleManager: AddressLike
  ];
  export type OutputTuple = [oldRoleManager: string, newRoleManager: string];
  export interface OutputObject {
    oldRoleManager: string;
    newRoleManager: string;
  }
  export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>;
  export type Filter = TypedDeferredTopicFilter<Event>;
  export type Log = TypedEventLog<Event>;
...
export interface AttendanceNFT extends BaseContract {
  ...
  tokenSessionIds: TypedContractMethod<[arg0: BigNumberish], [bigint], "view">;
  ...
  >;
  getEvent(
    key: "RoleManagerUpdated"
  ): TypedContractEvent<
    RoleManagerUpdatedEvent.InputTuple,
    RoleManagerUpdatedEvent.OutputTuple,
    RoleManagerUpdatedEvent.OutputObject
  >;
  getEvent(
    key: "Transfer"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "RoleManagerUpdated(address,address)": TypedContractEvent<
      RoleManagerUpdatedEvent.InputTuple,
      RoleManagerUpdatedEvent.OutputTuple,
      RoleManagerUpdatedEvent.OutputObject
    >;
    RoleManagerUpdated: TypedContractEvent<
      RoleManagerUpdatedEvent.InputTuple,
      RoleManagerUpdatedEvent.OutputTuple,
      RoleManagerUpdatedEvent.OutputObject
    >;
