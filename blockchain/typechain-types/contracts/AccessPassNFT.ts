...
export interface AccessPassNFTInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "LAB_ACCESS_PASS",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "OFFICE_HOUR_PASS",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "WORKSHOP_PASS",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface AccessPassNFT extends BaseContract {
  ...
  LAB_ACCESS_PASS: TypedContractMethod<[], [bigint], "view">;

  OFFICE_HOUR_PASS: TypedContractMethod<[], [bigint], "view">;

  WORKSHOP_PASS: TypedContractMethod<[], [bigint], "view">;
  ...
  getFunction(
    nameOrSignature: "LAB_ACCESS_PASS"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
    nameOrSignature: "OFFICE_HOUR_PASS"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
    nameOrSignature: "WORKSHOP_PASS"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
