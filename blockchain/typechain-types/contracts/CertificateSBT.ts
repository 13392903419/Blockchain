...
export interface CertificateSBTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface CertificateSBT extends BaseContract {
  connect(runner?: ContractRunner | null): CertificateSBT;
  waitForDeployment(): Promise<this>;

  interface: CertificateSBTInterface;
  ...
  issueCertificate: TypedContractMethod<
    [student: AddressLike, _tokenURI: string],
    [bigint],
    "nonpayable"
  >;
